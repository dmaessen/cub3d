...
/*   Updated: 2024/01/18 15:15:33 by dmaessen         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void background_img(t_data *data)
{
    ...
    color = ft_pixel(data->colors->c_color_r, data->colors->c_color_g, data->colors->c_color_b, 0xFF);
    color_floor = ft_pixel(data->colors->f_color_r, data->colors->f_color_g, data->colors->f_color_b, 0xFF);
    y = 0;
    while (y < HEIGHT)
    {
        if (y > (HEIGHT / 2))
